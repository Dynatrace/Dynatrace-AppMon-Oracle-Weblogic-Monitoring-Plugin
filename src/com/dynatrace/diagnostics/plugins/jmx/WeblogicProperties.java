...
public class WeblogicProperties {
	...
	private Boolean ejb;
	private Boolean mbd;
	private Boolean RegexAppData;
	private Boolean RegexAppState;
	...
	private String messageBridgeServer;
	...
	public String getMessageBridgeServer() {
		return messageBridgeServer;
	}
	public void setMessageBridgeServer(String messageBridgeServer) {
		this.messageBridgeServer = messageBridgeServer;
	}
...
/*	public String getSystemProfile() {
	...
	public Boolean getsslTrust() {
		return sslTrust;
	}
	public void setsslTrust(Boolean sslTrust) {
		this.sslTrust = sslTrust;
	}
	public String getcustomTrust() {
		return customTrust;
	}
	public void setcustomTrust(String customTrust) {
		this.customTrust = customTrust;
	}
	...
	public Boolean getRegexAppData() {
		return RegexAppData;
	}
	public void setRegexAppData(Boolean RegexAppData) {
		this.RegexAppData = RegexAppData;
	}
	public Boolean getRegexAppState() {
		return RegexAppState;
	}
	public void setRegexAppState(Boolean RegexAppState) {
		this.RegexAppState = RegexAppState;
	}
